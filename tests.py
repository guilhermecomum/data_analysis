...
class TestDataAnalysis(unittest.TestCase):
    ...
    def test_ranking_salesman(self):
        self.assertEqual(data_analysis.ranking_salesman(self.sales, self.salesmans), [('Renato', 393.5), ('Diego', 1199.0)])

    def test_expensive_sale(self):
        self.assertEqual(data_analysis.expensive_sale(self.sales), ['10', 1199.0, 'Diego'])
